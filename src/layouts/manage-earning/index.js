          ...
          <Grid item xs={12}>
            <Card>
              ...
              <MDBox pt={3} pb={2} px={2}>
                <Button variant="gradient" color={darkMode ? "dark" : "info"} onClick={() => setOpen(true)} sx={{ mb: 2 }}>
                  Add Earning
                </Button>
                <DataTable
                  table={tableData}
                ...
                {category === "Project Revenue" && (
                  <Grid item xs={12}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField {...params} label="Select Project" fullWidth sx={{ input: { color: darkMode ? "white" : "black" }, "& .MuiInputLabel-root": { color: darkMode ? "white" : "black" } }} />
                      )}
                    />
                  </Grid>
                )}
                {(category === "Service Revenue" ||
                  ...
                  <Grid item xs={12}>
                    <Autocomplete
                      ...
                      onChange={(e, newValue) => setReference(newValue)}
                      renderInput={(params) => (
                        <TextField {...params} label="Select Client" fullWidth sx={{ input: { color: darkMode ? "white" : "black" }, "& .MuiInputLabel-root": { color: darkMode ? "white" : "black" } }} />
                      )}
                    />
                  </Grid>
                )}
                {(category === "Commission Income" ||
                  ...
                  <Grid item xs={12}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField {...params} label="Select Account" fullWidth sx={{ input: { color: darkMode ? "white" : "black" }, "& .MuiInputLabel-root": { color: darkMode ? "white" : "black" } }} />
                      )}
                    />
                  </Grid>
                )}
